    ...
    <div id="portfolio">
        ...
        <div class="container experience">
            ...
            <div class="row mt-4" data-aos="fade-up"  data-aos-duration="1500" data-aos-once="true" data-aos-delay="600">
                ...
                <div class="col-lg-7">
                     <p class="profile-content-color profile-content">
                     Bootstrap 5 網頁切版整合術<br>
                     JavaScript 入門篇 - 學徒的試煉<br>
                     JS 必修篇最終關卡任務<br>
                     JavaScript 核心篇(學習中)<br>
                     Vue 3 實戰影音課程</p>
                </div>
            ...
            <div class="row mt-4" data-aos="fade-up" data-aos-duration="1500" data-aos-once="true" data-aos-delay="600">
                ...
                <div class="col-lg-7">
                     <div class="profile-content-color profile-content">
                    ...
                    <div class="section-job mt-3">
                        <p class="fw-bold mb-0">國光客運智慧車載管理系統</p>
                        <span>接觸到「Vue.js」前端框架，並且與團隊工程師一起進行前端開發。使用Azure Devops 程式編輯協同合作</span>
                     </div>
                  </div>
                </div>
            ...
            <div class="row mt-4" data-aos="fade-up"  data-aos-duration="1500" data-aos-once="true" data-aos-delay="600">
                ...
                <div class="col-lg-7">
                     <p class="profile-content-color profile-content">
                     為公司進行官網設計以及Logo CIS 設計<br>
                     更加熟悉前端框架「Bootstrap」，並以此框架為基準，進行官網製作<br>
                     因應公司需求時常進行快速設計提案，更加熟悉提案的技巧以及快速設計方法</p>
                </div>
            ...
            <div class="row mt-4" data-aos="fade-up"  data-aos-duration="1500" data-aos-once="true" data-aos-delay="600">
                ...
                <div class="col-lg-7">
                     <p class="profile-content-color profile-content">
                     接觸到前端的領域，負責商品網頁的前端製作<br>
                     和設計師使用zeplin溝通，完成不同裝置的響應式網站設計<br>
                     參與app-iKlips(上架於App Store) 製作，使用Sketch進行協同設計</p>
                </div>
            ...
            <div class="row mt-3 offset-lg-1" data-aos="fade-up"  data-aos-duration="1000" data-aos-once="true">
                <div class="col-lg-2 px-0">
                    ...
                    <div class="profile-content-color">
                        <p class="mb-1">HTML5 / CSS3</p>
                        <p class="mb-1">Bootstrap 5</p>
                        <p class="mb-1">SVG 動畫</p>
                        <p class="mb-1">使用GitHub上傳網站</p>
                        <p class="mb-1">RWD 手刻網頁版面</p>
                ...
                <div class="col-lg-3 px-0">
                    ...
                    <p class="dash-border"></p>
                    <div class="profile-content-color">
                        <p class="mb-1">熟悉 JavaScript 基礎語法</p>
                        <p class="mb-1">學習ES6程式語法</p>
                        <p class="mb-1">AJAX/JSON串接第三方API</p>
                        <p class="mb-1">使用jQuery做出網頁互動效果</p>
                ...
                <div class="col-lg-3 px-0">
                    ...
                    <p class="dash-border"></p>
                    <div class="profile-content-color">
                        <p class="mb-1">使用Vue-Cli開發專案</p>
                        <p class="mb-1">使用Vue-Router套件管理專案路由</p>
                        <p class="mb-1">使用Components管理員件</p>
                        <p class="mb-1">加入Vue第三方套件(Vuetify、vue-loading-overlay)</p>
                ...
                <div class="col-lg-3 px-0">
                    ...
                    <p class="dash-border"></p>
                    <div class="profile-content-color">
                        <p class="mb-1">使用Figma、Sketch設計UI介面</p>
                        <p class="mb-1">使用AI、PS進行平面設計</p>
                        <p class="mb-1">使用Zeplin跟工程師進行協同合作</p>
